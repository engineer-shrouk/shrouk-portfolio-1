...
const projects = {
    ...
    superstore: {
        ...
        description: "The goal was not just to visualize the data, but to explore it and turn raw numbers into meaningful business insights.",
        ...
        takeaway: "Through this project, I practiced how to move from raw data → analysis → insights → better business understanding.",
        skills: "Excel · Power Query · Data Visualization · Dashboard Design"
    },
    ...
    "town-team": {
        ...
        description: "An interactive Power BI dashboard designed to transform sales data into a clear and accessible business view.",
        workTitle: "WHAT I WORKED ON",
        work: [
...
function openProject(projectId) {
    ...
    if (modalWorkTitle && modalWork) {
        modalWorkTitle.textContent = project.workTitle;
        modalWork.innerHTML = "";
    ...
    const modalInsightsTitle = document.getElementById("modalInsightsTitle");
    const modalInsights = document.getElementById("modalInsights");
    if (modalInsightsTitle && modalInsights) {
        modalInsightsTitle.textContent = project.insightsTitle;
    ...
    document.getElementById("modalTakeaway").textContent = project.takeaway;
